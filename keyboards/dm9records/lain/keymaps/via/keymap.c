...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        KC_TAB,  KC_Q,    KC_W,    KC_E,         KC_R,   KC_T,    KC_Y,              KC_Y,            KC_U,     KC_I,    KC_O,    KC_P,     KC_MINS,
        ...
        _______,          _______, LALT(KC_ESC), KC_SPC, KC_LANG2,         KC_LANG1, LT(NUM, KC_ENT), MO(FUNC), _______, _______,           _______
    ),
    [NUM] = LAYOUT(
        KC_JYEN, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,             KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_EQL,
        _______, KC_TILD, _______, KC_LCBR, KC_LPRN, KC_LBRC, _______,          KC_RBRC, KC_RPRN, KC_RCBR, _______, KC_PIPE, KC_PLUS,
